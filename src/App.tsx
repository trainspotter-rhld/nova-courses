...
function App() {
  ...
  <h1 className=' text-3xl font-thin font-mono'>Learn.<span className='font-extrabold text-blue-400'>Coding.</span>Now<span className='text-green-500'>();</span></h1>
  ...
  <div className="grid grid-rows-2 grid-cols-2 px-96">
